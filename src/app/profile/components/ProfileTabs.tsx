...
export function ProfileTabs({dehydratedState,profile_posts_key}:ProfileTabsProps){
...
return (
    ...
    <Tabs defaultValue="posts" className="w-full" >
        ...
        <TabsContent value="followers">
         <InfiniteFriends user={pb.authStore.model as unknown as PBUserRecord} type={"followers"} logged_in={pb.authStore.model as unknown as PBUserRecord}/>
        </TabsContent>

        <TabsContent value="following">
            <InfiniteFriends user={pb.authStore.model as unknown as PBUserRecord} type={"following"} logged_in={pb.authStore.model as unknown as PBUserRecord} />
        </TabsContent>
        </HydrationBoundary>
    </Tabs>
);
