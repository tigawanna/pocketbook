...
export function useMutationWrapper<V,R>({fetcher,setError,refresh,invalidates,success_message}:IUseMutation<V,R>){
  ...
  return useMutation({
    ...
    onSuccess(data, variables, context) {
      ...
      updateNotification({ type: "success", message: success_message ?? "success" })
